...
public class GUI extends JFrame {
    ...
    private JButton createPlayerButton = new JButton("CREATE CHARACTER ");
    private JButton selectPlayerButton = new JButton("SELECT CHARACTER");
    ...
    public void displayFrame() {
        ...
        playerNameField.setForeground(Color.RED);
    ...
    public void displayGUI() {
        createPlayerButton.setBounds(140, 170, 220, 40);
        ...
        selectPlayerButton.setBounds(140, 260, 220, 40);
...
//                displayFrame();
    ...
    public void selectHero() {
        ...
        selectExistingPlayer.setBounds(100, 10, 300, 30);
    ...
    public void play() {
        ...
        playground.setForeground(Color.ORANGE);
